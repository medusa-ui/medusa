...
class MedusaOnClickTest extends MedusaTagTest {
    ...
    void basicRenderTest() {
        ...
        Assertions.assertTrue(template.contains("onclick=\"_M.doAction('__FRAGMENT__', `increment()`)\""), "Medusa tag should be rendered with replacement JS");
    }
    ...
    void parameterRenderTest() {
        ...
        Assertions.assertFalse(template.contains("th:text="), "Thymeleaf tags should be rendered");
        Assertions.assertFalse(template.contains("m:click="), "Medusa tags should be rendered");
        Assertions.assertTrue(template.contains("onclick=\"_M.doAction('__FRAGMENT__', `increment(2,'some text')`)\""), "Medusa tag should be rendered with replacement JS");
    }
    ...
    void attributeValueRenderTest() {
        ...
        Assertions.assertFalse(template.contains("th:text="), "Thymeleaf tags should be rendered");
        Assertions.assertFalse(template.contains("m:click="), "Medusa tags should be rendered");
        Assertions.assertTrue(template.contains("onclick=\"_M.doAction('__FRAGMENT__', `action(1,2)`)\""), "Medusa tag should be able to find element values");
    }
    ...
    void elementValueRenderTest() {
        ...
        Assertions.assertFalse(template.contains("th:text="), "Thymeleaf tags should be rendered");
        Assertions.assertFalse(template.contains("m:click="), "Medusa tags should be rendered");
        Assertions.assertTrue(template.contains("onclick=\"_M.doAction('__FRAGMENT__', `action('${document.querySelector('#elm_1').value}', '${document.querySelector('#elm_2').value}')`)\""), "Medusa tag should be able to find element values");
    }
    @Test
    void complexValueRenderTest() {
        ...
        Assertions.assertFalse(template.contains("th:text="), "Thymeleaf tags should be rendered");
        Assertions.assertFalse(template.contains("m:click="), "Medusa tags should be rendered");
        Assertions.assertTrue(template.contains("onclick=\"_M.doAction('__FRAGMENT__', `action('4', 3, 2, '${document.querySelector('#elm_1').value}')`)\""), "Medusa tag should be able to find element values");
    }
}
